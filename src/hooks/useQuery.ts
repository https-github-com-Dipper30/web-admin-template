...
export type QueryFunction<T = any, P = any> = (...args: any) => APIPromise<T>
...
const useQuery = <T = any, P = any>(fn: QueryFunction<T, P>, options?: UseQueryOptions<T>, deps?: any[]) => {
    ...
    async (p?: P) => {
      try {
        ...
        const result = handleResult(res, {
          ...
          successMessage: typeof showSuccess === 'string' ? showSuccess : res.msg,
